...
const HomeHeroSection = () => {
  ...
  useEffect(() => {
    ...
    const rotate = () => {
      cards.forEach((card, i) => {
        ...
        card.style.transform = `translate(-50%, -50%) translate(${x}px, ${y}px) rotateY(${theta}deg)`;
      });
  ...
  const styles = {
    ...
    "@media (max-width: 992px)": {
      ...
      left: { flex: "0 0 100%", marginBottom: "40px" },
      right: { flex: "0 0 100%", paddingLeft: "0", textAlign: "center" },
    },
  };
